...
impl Parse for A5_28 {
        ...
        Self: Sized,
    {
        ...
        match (op1, op2, ra) {
            ...
            (0b010, 0 | 1, 0b1111) => Ok(Self::Smuad(Smuad::parse(iter)?)),
            (0b010, 0 | 1, _) => Ok(Self::Smlad(Smlad::parse(iter)?)),
            (0b011, 0 | 1, 0b1111) => Ok(Self::Smulw(Smulw::parse(iter)?)),
            (0b011, 0 | 1, _) => Ok(Self::Smlaw(Smlaw::parse(iter)?)),
            (0b100, 0 | 1, 0b1111) => Ok(Self::Smusd(Smusd::parse(iter)?)),
            (0b100, 0 | 1, _) => Ok(Self::Smlsd(Smlsd::parse(iter)?)),
            (0b101, 0 | 1, 0b1111) => Ok(Self::Smmul(Smmul::parse(iter)?)),
            (0b101, 0 | 1, _) => Ok(Self::Smmla(Smmla::parse(iter)?)),
            (0b110, 0 | 1, _) => Ok(Self::Smmls(Smmls::parse(iter)?)),
